                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-12 mb-16">
                    ...
                    <div className="col-span-1 md:col-span-1 space-y-6">
                        <Link to="/" className="flex items-center gap-4 group">
                            <img src="/flashudlogo.png" alt="Flashud" className="w-8 h-8 object-contain" />
                    ...
                    <div className="col-span-1">
                        ...
                        <ul className="space-y-4">
                            ...
                            <li><Link to="/shop/category" className="text-[10px] font-medium tracking-[0.2em] text-brand-dark/60 uppercase hover:text-brand-orange transition-colors">Collections</Link></li>
