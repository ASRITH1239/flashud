...
const Home = () => {
    ...
    return (
        <div className="mx-auto selection:bg-brand-orange selection:text-white pb-20">
            {/* Hero Section */}
            <section className="-mt-20 mb-24 relative w-full h-[300vh]">
                <div className="sticky top-0 w-full h-screen overflow-hidden">
                    {heroImage ? (
                        <img src={heroImage} alt="Flashud Hero" className="w-full h-full object-cover" />
                    ) : (
                    ...
                    <div className="absolute inset-0 z-10 flex flex-col items-center justify-center text-center px-4">
                        <h1 className="text-6xl md:text-8xl font-light mb-8 tracking-[0.1em] leading-none text-white uppercase drop-shadow-md">
                            UPGRADE <span className="font-bold text-brand-orange">YOUR</span> IDENTITY
                        </h1>
                        <p className="text-xs md:text-sm font-medium tracking-[0.2em] mb-12 text-white/90 uppercase max-w-2xl mx-auto drop-shadow-sm">
                        ...
                        <Link to="/shop" className="inline-block px-14 py-5 rounded-full bg-white text-brand-dark font-bold uppercase tracking-widest text-sm hover:bg-brand-orange hover:text-white hover:-translate-y-1 transition-all shadow-xl">
                            ENTER THE ARCHIVE
                        </Link>
                    </div>
            ...
            <div className="max-w-7xl mx-auto px-6">
                {/* Featured Grid */}
                <section>
                    <div className="flex justify-between items-end mb-14 border-b border-black/5 pb-6">
                        <div>
                            <h2 className="text-3xl font-light uppercase tracking-[0.2em] text-brand-dark">FEATURED <span className="font-bold text-brand-orange">DROPS</span></h2>
                            <p className="text-[10px] font-semibold text-brand-dark/50 uppercase tracking-[0.2em] mt-3">Limited availability / Zero compromise</p>
                        </div>
