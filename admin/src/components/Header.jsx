    ...
    return (
        <header className="w-full h-20 bg-fashion-black border-b-2 border-fashion-orange flex items-center justify-between px-10">
            ...
            <nav className="flex items-center gap-8">
                ...
                <button className="px-5 py-2 border-2 border-fashion-orange text-fashion-orange font-bold hover:bg-fashion-orange hover:text-fashion-black transition-all">
                    LOGOUT
                </button>
            </nav>
        </header>
